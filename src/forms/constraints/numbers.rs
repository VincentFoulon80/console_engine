...
mod test {
    ...
    fn integer() {
        ...
        let validator = Integer::new("should be an integer");
    ...
    fn number() {
        ...
        let validator = Number::new("should be a number");
        ...
        let mut hm: HashMap<String, FormValue> = HashMap::new();
        assert!(validator.validate(&FormValue::Map(hm.clone())));
        hm.insert(String::from("1"), FormValue::String(String::from("37")));
        assert!(validator.validate(&FormValue::Map(hm.clone())));
        hm.insert(String::from("2"), FormValue::String(String::from("-35")));
        assert!(validator.validate(&FormValue::Map(hm.clone())));
        hm.insert(String::from("3"), FormValue::String(String::from("3.5")));
        assert!(validator.validate(&FormValue::Map(hm.clone())));
        hm.insert(String::from("4"), FormValue::String(String::from("-3.5")));
        assert!(validator.validate(&FormValue::Map(hm.clone())));
        hm.insert(String::from("5"), FormValue::Nothing);
        assert!(!validator.validate(&FormValue::Map(hm)));
    }
}
